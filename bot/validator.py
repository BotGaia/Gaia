...
class Validator:
    ...
    def __init__(self, domain_path, intents_path, stories_path):
        ...
        if os.path.isfile(intents_path):
            ...
            intent_files = [
                f for f in listdir(intents_path)
        ...
        if os.path.isfile(stories_path):
            ...
            stories_files = [
                f for f in listdir(stories_path)
    ...
    def verify_intents(self):
        ...
        for intent in intents_in_domain:
            ...
            if not found:
                a = ' is in the domain file but was'
                b = ' not found in the intent files'
                logger.error('The intent ' + intent + a + b)
            else:
        ...
        for intent in intents_in_files:
            ...
            if not found:
                a = ' is in the intent files but was'
                logger.error('The intent ' + intent + a +
    ...
    def verify_intents_being_used(self):
        ...
        for intent in self.valid_intents:
            ...
            if not found:
                a = ' is not being used in any story'
                logger.warning('The intent ' + intent + a)
    ...
    def verify_utters(self):
        ...
        for i in range(start, len(domain_lines)):
            ...
            if s_line.split('_')[0] == 'utter':
                ...
                len(s_line.split()) >= 1 and s_line.split()[0] != '-'
                ) and (
        ...
        for utter in utter_templates:
            ...
            if not found:
                a = ' is not listed in actions'
                logger.error('The utter ' + utter + a)
    ...
    def verify_utters_being_used(self):
        ...
        for utter in self.valid_utters:
            ...
            if not found:
                a = ' is not being used in any story'
                logger.warning('The utter ' + utter + a)
